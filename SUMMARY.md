...
* [Access to getInvoice](access-to-getinvoice/README.md)
  ...
  * [SEND TO BUYER](access-to-getinvoice/send-to-buyer/README.md)
    ...
    * [Managing forbidden email status and cancel the status.](access-to-getinvoice/send-to-buyer/managing-forbidden-email-status-and-cancel-the-status..md)
    * [Managing Do Not Send SMS Status and Cancel Status](access-to-getinvoice/send-to-buyer/managing-do-not-send-sms-status-and-cancel-status.md)
  * [SEND TO RD (The Revenue Department)	](access-to-getinvoice/send-to-rd-the-revenue-department/README.md)
    ...
    * [Do not send to Revenue Department](access-to-getinvoice/send-to-rd-the-revenue-department/do-not-send-to-revenue-department.md)
